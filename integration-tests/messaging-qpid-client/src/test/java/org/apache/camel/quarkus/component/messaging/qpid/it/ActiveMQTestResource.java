 ...
 */
package org.apache.camel.quarkus.component.messaging.qpid.it;
    ...
    public Map<String, String> start() {
        ...
        try {
            container = new GenericContainer<>(ACTIVEMQ_IMAGE)
                    .withExposedPorts(ACTIVEMQ_PORT, ACTIVEMQ_PORT)
            ...
            String brokerUrlAmqp = String.format("amqp://127.0.0.1:%d", container.getMappedPort(ACTIVEMQ_PORT));

            return CollectionHelper.mapOf(
                    "quarkus.qpid-jms.url", brokerUrlAmqp,
